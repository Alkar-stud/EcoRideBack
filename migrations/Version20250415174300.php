 ...
 */
final class Version20250415174300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, energy_id INT NOT NULL, brand VARCHAR(50) NOT NULL, model VARCHAR(255) NOT NULL, color VARCHAR(50) NOT NULL, registration VARCHAR(20) NOT NULL, registration_first_date DATE NOT NULL, nb_place INT NOT NULL, created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', updated_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', INDEX IDX_1B80E4867E3C61F9 (owner_id), INDEX IDX_1B80E486EDDF52D (energy_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
