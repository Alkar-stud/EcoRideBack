 ...
 */
final class Version20250416135001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE covoiturage (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, status_id INT NOT NULL, starting_address VARCHAR(255) NOT NULL, arrival_address VARCHAR(255) NOT NULL, starting_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', trip_duration INT NOT NULL, nb_credit INT NOT NULL, nb_place INT NOT NULL, INDEX IDX_28C79E897E3C61F9 (owner_id), INDEX IDX_28C79E896BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
